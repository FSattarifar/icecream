...
try {
    ...
    $pdo->exec("
        ...
        (1, 'بستنی زعفرانی', 'بستنی سنتی با طعم زعفران و خامه.', 40000, 'img-3.png'),
        (2, 'بستنی توت‌فرنگی', 'بستنی خوشمزه با طعم توت‌فرنگی طبیعی.', 35000, 'img-5.png');
    ");
    ...
    echo "✅ جداول و داده‌های نمونه با موفقیت ایجاد شدند.";
